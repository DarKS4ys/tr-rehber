...
import PlacePlaceholder from '@/public/place.svg'
import { usePathname } from 'next/navigation';
import Link from 'next/link';

export default function PlaceAddButton() {
    const pathname = usePathname()
  return (
    <Link href={encodeURI(`${pathname}?modal=true&input=Bana turistik bir yer öner.`)} className="group text-start w-full min-w-[16rem] h-64 flex flex-col bg-background rounded-xl overflow-hidden">
